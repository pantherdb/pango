...
export class PantherPerfectScrollbarDirective implements AfterViewInit, OnDestroy {
    ...
    @Input()
    set pantherPerfectScrollbarOptions(value) {
        this._options = _.merge({}, this._options, value);
    }

    get pantherPerfectScrollbarOptions(): any {
        return this._options;
    }

    @Input('pantherPerfectScrollbar')
    ...
    ngAfterViewInit(): void {
        ...
        if (this.pantherPerfectScrollbarOptions.updateOnRouteChange) {
            this._router.events
                .pipe(
    ...
    _init(): void {
        ...
        this.ps = new PerfectScrollbar(this.elementRef.nativeElement, {
            ...this.pantherPerfectScrollbarOptions
        });
    }
