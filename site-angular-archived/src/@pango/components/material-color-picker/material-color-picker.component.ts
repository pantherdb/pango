...
import { pangoAnimations } from '../../animations';
import { MatColors } from '../../mat-colors';

@Component({
    selector: 'pango-material-color-picker',
    templateUrl: './material-color-picker.component.html',
    styleUrls: ['./material-color-picker.component.scss'],
    animations: pangoAnimations,
    encapsulation: ViewEncapsulation.None
})
export class PangoMaterialColorPickerComponent implements OnChanges {
    colors: any;
    selectedColor: any;
    hues: string[];
    view = 'palettes';
