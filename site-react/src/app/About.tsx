...
const AboutPage: React.FC = () => {
  ...
  return (
    <div className="w-full pt-14 bg-gray-50">
      <div className="max-w-4xl flex flex-col items-stretch mx-auto">
        <h1 className="text-5xl mb-6">About page</h1>

        <h2 className="text-3xl mb-8">About the human gene functionome</h2>
        ...
        <p className="mb-4">
          ...
          <a className="text-blue-500">[link to paper when available]</a>, a collaboration between the{' '}
          <a
        ...
        <ol className="list-decimal pl-6 mb-10">
          <li className="mb-2">
        ...
        <h3 className="text-2xl font-semibold mb-4">Important Details:</h3>
